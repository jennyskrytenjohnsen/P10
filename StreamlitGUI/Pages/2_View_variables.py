...
col1, col2 = st.columns([15, 1])  # Adjust width ratio as needed

# Display only patient name in the right column
# with col2:
#     if "patient_option" in st.session_state:
#         st.markdown(
#             f"""
#             Selected Patient: {st.session_state.patient_option}
#             """,
